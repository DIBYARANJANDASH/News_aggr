...
//const container = document.querySelector(".container");
//
//// GNews API endpoint (use `top-headlines` as the query)
//let requestURL = `https://gnews.io/api/v4/search?q="top-headlines"&apikey=b30033fd80f44a50cec737303c807bd8&lang=en`;
//
//// Create news cards from data
//const generateUI = (articles) => {
//  container.innerHTML = ""; // Clear existing content
